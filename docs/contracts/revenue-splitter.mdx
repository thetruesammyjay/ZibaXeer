...
`RevenueSplitter` only processes **realized profit**. There are no recurring management fees. If a vault performs poorly, neither the leader nor the protocol collects anything — fully aligning incentives.
